                    ...
                    <ul class="to-form-field-list">
                        <li>
                            ...
                            <div class="to-radio-button">
                                ...
                                <input type="radio" name="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_enable'); ?>" id="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_enable_2'); ?>" value="-1" <?php Autospa_ThemeHelper::checkedIf($this->data['option']['post_header_bottom_enable'],-1); ?>/>
                                <label for="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_enable_2'); ?>"><?php esc_html_e('- Use global settings -','autospa'); ?></label>
                            </div>			
                        </li>
                        <li>
                            ...
                            <div class="to-radio-button">
                                ...
                                <input type="radio" name="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_breadcrumb_enable'); ?>" id="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_breadcrumb_enable_2'); ?>" value="-1" <?php Autospa_ThemeHelper::checkedIf($this->data['option']['post_header_bottom_breadcrumb_enable'],-1); ?>/>
                                <label for="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_breadcrumb_enable_2'); ?>"><?php esc_html_e('- Use global settings -','autospa'); ?></label>
                            </div>			
                        </li> 
                        <li>
                            ...
                            <div class="to-clear-fix">
                                ...
                                <input class="to-color-picker" type="text" name="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_normal_state_background_color'); ?>" id="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_normal_state_background_color'); ?>" class="to-float-left" value="<?php echo esc_attr($this->data['option']['post_header_bottom_normal_state_background_color']); ?>" />
                            </div>
                            <div class="to-clear-fix">
                                <span class="to-legend-field"><?php esc_html_e('Text color:','autospa'); ?></span>
                                <input class="to-color-picker" type="text" name="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_normal_state_text_color'); ?>" id="<?php Autospa_ThemeHelper::getFormName('post_header_bottom_normal_state_text_color'); ?>" class="to-float-left" value="<?php echo esc_attr($this->data['option']['post_header_bottom_normal_state_text_color']); ?>" />
                            </div>
                        </li> 
                    </ul>
                </div>
