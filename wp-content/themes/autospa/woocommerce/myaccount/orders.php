...
<?php if ( $has_orders ) : ?>
	...
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table my_account_orders account-orders-table theme-table-responsive-on">
		<thead>
			<tr>
...
$shortcode=
'
    [vc_autospa_theme_notice icon="alarm" icon_background_color="#EA5F38" header_text="'.__('Error','autospa').'"]'.__('No order has been made yet.','woocommerce').'[/vc_autospa_theme_notice]
';
